(function($,undefined){
	...
	, formUrl= _ctx+"/integrity/monitor/mac/form"
	, delUrl= _ctx+"/integrity/monitor/mac/del";
	 $(function(){
				...
				common.openurl(formUrl, {
					...
					onLoad:function(){
						$.util.exec(function(){
							...
							var _ipcontent = _row["macstrategycontent"]||"";
